...
class MainWindow:
    ...
    def __init__(self, root):
        ...
        root.title("Secrefy")
        root.configure(bg="#e4d4c3")

        try:
            icon_img = tk.Image(
                "photo",
                file=self.THIS_FOLDER_G + "/assets/secrefy.png"
            )
            root.call(
                "wm",
                "iconphoto",
...
3. Click ENCRYPT Button to encrypt. A new encrypted file with ".sfy" extention e.g. "abc.jpg.sfy" will be created in the same directory where the "abc.jpg" is.
4. When you want to Decrypt a file you, will select the file with the ".sfy" extention and Enter your Secret Key which you chose at the time of Encryption. Click DECRYPT Button to decrypt. The decrypted file will be of the same name as before with the suffix "_desfy" e.g. "abc_desfy.jpg".
